...
contract ArbiterIntegrationTest is Test, ArbiterHelpers {
    ...
    function setUp() public {
        ...
        arbiter = new Arbiter(governor, verifierProxy, linkToken, priceMaxStaleness, minLinkDataStreams);
        ...
        arbiter.setArbiterJob(flEthUsdc, rewardVault, automationForwarder, 1e18, 1e18, 0, 0);
